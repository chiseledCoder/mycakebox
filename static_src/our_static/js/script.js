...
function loadGoogleMap() {    
    ...
    var latlng = new google.maps.LatLng(19.2070331,72.9809794); // New York
    var settings = {
        zoom: 14,
        center: new google.maps.LatLng(19.2070331,72.9809794),
    ...
    var companyImage = new google.maps.MarkerImage("https://mycakebox.s3.ap-south-1.amazonaws.com/images/map-marker.png",
        new google.maps.Size(64,64),// Width and height of the marker
        new google.maps.Point(0,0),
        new google.maps.Point(19,72)// Position of the marker 
    );

    var companyPos = new google.maps.LatLng(19.2070331,72.9809794);
